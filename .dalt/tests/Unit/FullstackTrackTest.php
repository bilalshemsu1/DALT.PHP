...
test('the Fullstack manifest describes all planned parts and only real Fullstack lessons', function () {
    ...
    expect(array_map(static fn (string|int $part): int => (int) $part, array_keys($track['parts'])))->toBe(range(0, 12))
        ...
        ->and($track['parts']['06']['lessons'])->toBe(['39-fs06-1-backend-api-behavior-tests', '40-fs06-2-users-passwords-sessions-and-csrf', '68-fs06-3-login-logout-and-server-sessions', '69-fs06-4-csrf-and-cookie-authenticated-writes', '41-fs06-3-authorization-and-ownership'])
        ->and($track['parts']['06']['milestones'][0])->toMatchArray(['id' => 'B06', 'route' => '/learn/fullstack/build/b06', 'prerequisites' => ['39-fs06-1-backend-api-behavior-tests', '40-fs06-2-users-passwords-sessions-and-csrf', '68-fs06-3-login-logout-and-server-sessions', '69-fs06-4-csrf-and-cookie-authenticated-writes', '41-fs06-3-authorization-and-ownership']])
        ->and($track['parts']['07']['lessons'])->toBe(['42-fs07-1-urls-and-react-router', '43-fs07-2-authentication-in-the-frontend', '44-fs07-3-test-frontend-behavior', '70-fs07-4-test-routes-sessions-and-api-boundaries'])
        ->and($track['parts']['07']['milestones'][0])->toMatchArray(['id' => 'B07', 'route' => '/learn/fullstack/build/b07', 'prerequisites' => ['42-fs07-1-urls-and-react-router', '43-fs07-2-authentication-in-the-frontend', '44-fs07-3-test-frontend-behavior', '70-fs07-4-test-routes-sessions-and-api-boundaries']])
        ->and($track['parts']['08']['lessons'])->toBe(['45-fs08-1-client-state-versus-server-state', '71-fs08-2-query-keys-and-server-state-reads', '46-fs08-2-mutations-invalidation-and-optimistic-ui', '47-fs08-3-context-reducers-and-zustand'])
        ->and($track['parts']['08']['milestones'][0])->toMatchArray(['id' => 'B08', 'route' => '/learn/fullstack/build/b08', 'prerequisites' => ['45-fs08-1-client-state-versus-server-state', '71-fs08-2-query-keys-and-server-state-reads', '46-fs08-2-mutations-invalidation-and-optimistic-ui', '47-fs08-3-context-reducers-and-zustand']])
        ->and($track['parts']['09']['lessons'])->toBe(['48-fs09-1-custom-hooks-and-feature-boundaries', '72-fs09-2-feature-boundaries', '49-fs09-2-build-pipeline-configuration-and-failure-boundaries'])
        ->and($track['parts']['09']['milestones'][0])->toMatchArray(['id' => 'B09', 'route' => '/learn/fullstack/build/b09', 'prerequisites' => ['48-fs09-1-custom-hooks-and-feature-boundaries', '72-fs09-2-feature-boundaries', '49-fs09-2-build-pipeline-configuration-and-failure-boundaries']])
        ->and($track['parts']['10']['milestones'][0])->toMatchArray(['id' => 'B10', 'route' => '/learn/fullstack/build/b10', 'prerequisites' => ['50-fs10-1-containers-around-the-application', '73-fs10-2-dockerfiles-and-build-context', '74-fs10-3-layers-cache-and-multistage-builds', '75-fs10-4-compose-networks-volumes-and-environment', '51-fs10-2-builds-health-and-debugging']])
        ->and($track['parts']['11']['lessons'])->toBe(['52-fs11-1-query-performance-and-postgresql-capabilities', '76-fs11-2-explain-composite-and-partial-indexes', '77-fs11-3-full-text-search-and-gin', '53-fs11-2-transactions-concurrency-and-row-isolation'])
        ->and($track['parts']['11']['milestones'][0])->toMatchArray(['id' => 'B11', 'route' => '/learn/fullstack/build/b11', 'prerequisites' => ['52-fs11-1-query-performance-and-postgresql-capabilities', '76-fs11-2-explain-composite-and-partial-indexes', '77-fs11-3-full-text-search-and-gin', '53-fs11-2-transactions-concurrency-and-row-isolation']])
        ...
        ->and(array_column($fullstackLessons, 'id'))->toBe(array_merge(
            ...
            ['33-fs04-1-fetching-data-and-effects', '63-fs04-2-loading-failure-and-races', '34-fs04-2-mutating-server-data', '35-fs04-3-separating-transport-from-ui', '64-fs05-1-modern-php-for-web-applications', '65-fs05-2-dalt-request-route-and-response', '36-fs05-1-designing-the-application-api', '37-fs05-2-relational-modeling-and-migrations', '66-fs05-5-migrations-constraints-and-indexes', '38-fs05-3-crud-queries-and-transaction-boundaries', '67-fs05-7-transaction-boundaries-and-failures', '39-fs06-1-backend-api-behavior-tests', '40-fs06-2-users-passwords-sessions-and-csrf', '68-fs06-3-login-logout-and-server-sessions', '69-fs06-4-csrf-and-cookie-authenticated-writes', '41-fs06-3-authorization-and-ownership', '42-fs07-1-urls-and-react-router', '43-fs07-2-authentication-in-the-frontend', '44-fs07-3-test-frontend-behavior', '70-fs07-4-test-routes-sessions-and-api-boundaries', '45-fs08-1-client-state-versus-server-state', '71-fs08-2-query-keys-and-server-state-reads', '46-fs08-2-mutations-invalidation-and-optimistic-ui', '47-fs08-3-context-reducers-and-zustand', '48-fs09-1-custom-hooks-and-feature-boundaries', '72-fs09-2-feature-boundaries', '49-fs09-2-build-pipeline-configuration-and-failure-boundaries', '50-fs10-1-containers-around-the-application', '73-fs10-2-dockerfiles-and-build-context', '74-fs10-3-layers-cache-and-multistage-builds', '75-fs10-4-compose-networks-volumes-and-environment', '51-fs10-2-builds-health-and-debugging', '52-fs11-1-query-performance-and-postgresql-capabilities', '76-fs11-2-explain-composite-and-partial-indexes', '77-fs11-3-full-text-search-and-gin', '53-fs11-2-transactions-concurrency-and-row-isolation'],
        ))
