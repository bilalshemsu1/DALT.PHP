...
test('the Fullstack manifest describes all planned parts and only real Fullstack lessons', function () {
    ...
    expect(array_map(static fn (string|int $part): int => (int) $part, array_keys($track['parts'])))->toBe(range(0, 12))
        ...
        ->and($track['parts']['10']['milestones'][0])->toMatchArray(['id' => 'B10', 'route' => '/learn/fullstack/build/b10', 'prerequisites' => ['50-fs10-1-containers-around-the-application', '73-fs10-2-dockerfiles-and-build-context', '74-fs10-3-layers-cache-and-multistage-builds', '51-fs10-2-builds-health-and-debugging']])
